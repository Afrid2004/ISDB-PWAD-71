...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link href="<?php echo $base_url?>/assets/css/css?family=Open+Sans:300,400,500,600,700%7cPoppins:300,400,500,600,700,800,900&amp;display=swap" rel="stylesheet">
          ...
          <div class="w-100">
            <div class="d-flex flex-between-center">
              ...
              <a class="navbar-brand me-1 me-sm-3" href="index.html">
                <div class="d-flex align-items-center"><img class="me-2" src="<?php echo $base_url?>/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40"><span class="font-sans-serif text-primary">falcon</span></div>
              </a>
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="<?php echo $base_url?>/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40"><span class="font-sans-serif text-primary">falcon</span></div>
            </a>
          </div>
