...
// print_r(array_map( fn($a)=> strtoupper($a) , ["Apple", "Banana"]));
// echo "<br>";
...
// echo array_reduce($arr, fn($acc, $item) => $acc + $item, 0) . "<br>";
...
// echo array_product([1, 2, 3, 4,5]) . "<br>";
...
// print_r(array_diff([1, 2, 3,5], [2, 3, 4]));
// echo "<br>";
...
// print_r(array_column($students, "name", "age"));
// echo "<br>";
...
<script>
 ...
 let updateArr= arr.map((e)=> e*2 );


 let abc= arr.reduce((acc, item)=> acc + item , 0);

 let php= {lang : "PHP", version : "8.0"}

 const {lang, version}= php;
