...
// echo "basename(): " . basename("E:/xampp/htdocs/pwad_71_class/class/php/file/example.txt") . "<br>";

// 18. dirname() - Get directory path
// echo "dirname(): " . dirname("E:/xampp/htdocs/pwad_71_class/class/php/file/example.txt") . "<br>";
